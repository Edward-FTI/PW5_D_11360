            ...
            <div class="row gx-lg-5 align-items-center mb-5">
                <div class="col-lg-6 mb-5 mb-lg-0" style="z-index: 10">
                    <h1 class="my-5 display-5 fw-bold ls-tight" style="color: hsl(207, 91%, 95%)">
                        Primefit Indonesia
                        <br>
                        <span style="color: hsl(207, 91%, 75%)">
                    ...
                    <p class="mb-4 opacity-70" style="color: hsl(207, 91%, 85%); text-align: justify;">
                        ...
                        meningkatkan kebugaran secara keseluruhan, kami siap mendukung setiap langkah Anda. Mari
                        bergabung dan rasakan kebersamaan dalam mencapai tujuan fitness Anda!
                    </p>
                </div>
